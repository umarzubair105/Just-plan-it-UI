...
export const routes: Routes = [
 ...
 // { path: 'company', component: CompanyComponent },
  ...
  { path: 'reset-password', loadComponent: ()=>import(
      './components/reset-password.component').then((m)=>m.ResetPasswordComponent)},
...
//  { path: 'upload-epic/:productId', loadComponent: ()=>import(
  ...
  { path: 'role', loadComponent: ()=>import(
    ...
    canActivate: [AuthGuard]},
  { path: 'profile', loadComponent: ()=>import(
      './components/profile.component').then((m)=>m.ProfileComponent),
    canActivate: [AuthGuard]},
